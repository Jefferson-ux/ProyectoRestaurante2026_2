...
/* ================================================ */
INSERT INTO proveedor_producto (id_proveedor, id_producto, precio_compra, tiempo_entrega, fecha_registro, estado) VALUES
    (1,  1,  2.10, 2, '2024-01-10', 1),
    (1,  3,  1.90, 2, '2024-01-10', 1),
    (1,  4,  2.50, 3, '2024-01-10', 1),
    (2, 16,  3.00, 2, '2024-02-05', 1),
    (2, 17,  1.70, 2, '2024-02-05', 1),
    (2, 18,  2.40, 2, '2024-02-05', 1),
    (3,  6,  7.80, 3, '2024-03-01', 1),
    (3,  7, 16.50, 3, '2024-03-01', 1),
    (3, 10, 12.00, 3, '2024-03-01', 1),
    (4,  8, 13.00, 2, '2024-03-15', 1),
    (4,  9, 32.00, 2, '2024-03-15', 1),
    (5, 31,  1.20, 1, '2024-04-01', 1),
    (5, 32,  4.00, 1, '2024-04-01', 1),
    (5, 33,  3.50, 1, '2024-04-01', 1),
    (6, 11,  3.80, 2, '2024-04-10', 1),
    (6, 12, 16.00, 2, '2024-04-10', 1),
    (6, 13, 19.00, 2, '2024-04-10', 1),
    (7, 27,  8.50, 4, '2024-05-01', 1),
    (7, 39,  3.80, 4, '2024-05-01', 1),
    (7, 40,  6.00, 3, '2024-05-01', 1);
